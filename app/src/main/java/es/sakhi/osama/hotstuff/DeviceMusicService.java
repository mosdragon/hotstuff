 ...
 * helper methods.
 */
public class DeviceMusicService extends IntentService {
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, DeviceMusicService.class);
    ...
    public DeviceMusicService() {
        super("DeviceMusicService");
    }
